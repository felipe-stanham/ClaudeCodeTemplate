...
7. **Architecture diagrams should suggest module/component names** that Claude Code will use in implementation. Where relevant, align these with subsystem names listed in `SYSTEM.md`.
