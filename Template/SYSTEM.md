...
> This file is **project-owned** — it is never overwritten by `template-sync`.
> Keep it under ~150 lines. Detail belongs in P/T/I files and their index files.
...
- Pitches: [docs/Pitches/INDEX.md](docs/Pitches/INDEX.md)
- Tasks: [docs/Tasks/INDEX.md](docs/Tasks/INDEX.md)
- Projects: [docs/Projects/INDEX.md](docs/Projects/INDEX.md)
