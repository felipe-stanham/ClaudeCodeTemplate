...
| `.claude/skills/` | Skills: `pitch` (idea refinement), `spec` (project specification), `glossary` (ubiquitous language), `deployment-process`, `share` (shareable HTML mini-sites from docs) |
